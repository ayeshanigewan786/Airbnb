# -*- coding: utf-8 -*-
"""Airbnb_Booking_Analysis_Exploratory_Data_Analysis_By_AYESHA NIGEWAN.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Gg4b4xxIPiNd94QTPYz2DYiCkZS3oYoJ
...
https://github.com/rajputyogesh0310/Airbnb-Booking-Exploratory-Data-Analysis
...
airbnb = pd.read_csv('/content/Airbnb NYC 2019 (1).csv')
airbnb

"""### Dataset Description and Information"""

airbnb.describe() # Describe the dataset

airbnb.info()  # Information of dataset

airbnb.isnull().sum()  # Checking missing values

airbnb.columns  # To get the columns of dataset

"""### Deleting the unnecesary columns"""

airbnb.drop(['latitude','longitude','last_review','reviews_per_month'],axis=1,inplace=True)  # Dropping

airbnb.head(10) # Taking the starting ten rows
...
room_dict = {} # Create a dictionary named room_dict to store the count of each room type.

for i in room_type:
  room_dict[i] = room_dict.get(i,0) + 1

plt.bar(room_dict.keys(),room_dict.values(),color = 'green', edgecolor='blue')  # Plot a bar graph using the plt.bbbar function.
...
numerical_features = airbnb.select_dtypes(include=['number'])
